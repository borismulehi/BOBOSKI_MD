...
var session = conf.session.replace(/BOBOSKI_MD-WHATSAPP-BOT;;;=>/g,"");
...
setTimeout(() => {
    async function main() {
        ...
        zk.ev.on("messages.upsert", async (m) => {
            ...
            const dj = '254718445203';
            const dj2 = '254750843027';
            const dj3 = "254718445203";
            const luffy = '254718445203';
...
┃ ┃⬡Boboski_MD⬡┃
┃    Prefix : [ ${prefixe} ]
┃    *BOBOSKI MD IS ACTIVE NOW*
┃    Total Commandes : ${evt.cm.length}
︎┃    Mode :${md} 
┃  •°• https://whatsapp.com/channel/0029VaH1iNI05MUX4zLNxR3V
┌┤✑  Thanks for Chooising BOBOSKI_MD 
│└────────────┈ ⳹        
